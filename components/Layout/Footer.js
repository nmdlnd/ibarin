...
const Footer = () => {
  return (
    <div className=" fixed sm:hidden bottom-0 mb-1 mx-1 right-0 left-0 z-20">
      <div className="bg-dark-500 w-full px-6 rounded-full">
        <ul className=" flex items-center justify-evenly text-white text-xs font-light py-2">
